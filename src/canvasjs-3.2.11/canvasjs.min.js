...
/*jshint ignore:start*/
(function() {
  function oa(k, m) { k.prototype = eb(m.prototype);
      k.prototype.constructor = k;
      k.base = m.prototype }

  function eb(k) {
      function m() {} m.prototype = k; return new m }
  ...
  function X(k, m) { var u = !1;
      0 > k && (u = !0, k *= -1);
      k = "" + k; for (m = m ? m : 1; k.length < m;) k = "0" + k; return u ? "-" + k : k }

  function Ga(k) { if (!k) return k;
      k = k.replace(/^\s\s*/, ""); for (var m = /\s/, u = k.length; m.test(k.charAt(--u));); return k.slice(0, u + 1) }
  ...
  function Q(k) { var m = ((k & 16711680) >> 16).toString(16),
          u = ((k & 65280) >> 8).toString(16);
      k = ((k & 255) >> 0).toString(16);
      m = 2 > m.length ? "0" + m : m;
      u = 2 > u.length ? "0" + u : u;
      k = 2 > k.length ? "0" + k : k; return "#" + m + u + k }
  ...
  function Ya(k, m, u) {
      ...
      if (isNaN(w)) {
          try {
              ...
              if (!wa) { var ra = document.body;
                  wa = document.createElement("span");
                  wa.innerHTML = ""; var D = document.createTextNode("Mpgyi");
                  wa.appendChild(D);
                  ra.appendChild(wa) } wa.style.display = "";
              wa.setAttribute("style", k);
              w = Math.round(wa.offsetHeight);
              wa.style.display = "none"
          } catch (y) { w = Math.ceil(1.1 * m) } w = Math.max(w, m);
          Za[r] = w
      }
      return w
  }
  ...
  function J(k, m, u, w, Ha) {
      ...
      w.push([k, m, u, Ha]);
      return k.addEventListener ? (k.addEventListener(m, u, Ha), u) : k.attachEvent ? (w = function(m) { m = m || window.event;
          m.preventDefault = m.preventDefault || function() { m.returnValue = !1 };
          m.stopPropagation = m.stopPropagation || function() { m.cancelBubble = !0 };
          u.call(k, m) }, k.attachEvent("on" +
          m, w), w) : !1
  }
  ...
  function ib(k) {
      ...
      if (!k._dropdownMenu && k.exportEnabled && w) {
          ...
          J(k._dropdownMenu, "blur", function() { ua(k._dropdownMenu);
          ...
          J(u, "click", function() { k.print();
              ua(k._dropdownMenu) }, k.allDOMEventHandlers, !0);
          u = document.createElement("div");
          u.style.cssText = "padding: 12px 8px 12px 8px";
          u.innerHTML =
          ...
          J(u, "mouseover", function() { m || (this.style.backgroundColor = k.toolbar.backgroundColorOnHover, this.style.color = k.toolbar.fontColorOnHover) }, k.allDOMEventHandlers, !0);
          J(u, "mouseout", function() { m || (this.style.backgroundColor = k.toolbar.backgroundColor, this.style.color = k.toolbar.fontColor) }, k.allDOMEventHandlers,
              !0);
          J(u, "click", function() { k.exportChart({ format: "jpeg", fileName: k.exportFileName });
              ua(k._dropdownMenu) }, k.allDOMEventHandlers, !0);
          u = document.createElement("div");
          u.style.cssText = "padding: 12px 8px 12px 8px";
          ...
          J(u, "mouseout", function() { m || (this.style.backgroundColor = k.toolbar.backgroundColor, this.style.color = k.toolbar.fontColor) }, k.allDOMEventHandlers, !0);
          J(u, "click", function() { k.exportChart({ format: "png", fileName: k.exportFileName });
              ua(k._dropdownMenu) }, k.allDOMEventHandlers, !0)
      }
  }
  ...
  function $a(k, m, u) {
      ...
      m = !0;
      for (u = 0; 4 > u; u++)
          if (k[u] !== k[u + 4] | k[u] !== k[u + 8] | k[u] !== k[u + 12]) { m = !1; break } return m ? k[0] <<
          16 | k[1] << 8 | k[2] : 0
  }

  function la(k, m, u) { return k in m ? m[k] : u[k] }

  function Na(k, m, u) { if (w && ab) { var r = k.getContext("2d");
          ...
          k.width = m * ga;
          k.height = u * ga;
          Sa !== Oa && (k.style.width = m + "px", k.style.height = u + "px", r.scale(ga, ga)) } else k.width = m, k.height = u }
  ...
  function Ta(k, m, u, r, w) { if (null === k || "undefined" === typeof k) return "undefined" === typeof u ? m : u;
      k = parseFloat(k.toString()) * (0 <= k.toString().indexOf("%") ? m / 100 : 1); "undefined" !== typeof r && (k = Math.min(r, k), "undefined" !== typeof w && (k = Math.max(w, k))); return !isNaN(k) && k <= m && 0 <= k ? k : "undefined" === typeof u ? m : u }
  ...
  function Ua(k, m) { Ua.base.constructor.call(this, "Toolbar", "toolbar", m, null, k);
      this.chart = k;
  ...
  function Ja(k, m, u) { Ja.base.constructor.call(this, "Subtitle", "subtitles", m, u, k);
      this.chart = k;
      this.canvas = k.canvas;
      this.ctx = this.chart.ctx;
  ...
  var hb = function() {
          ...
          try { var m = Object.defineProperty && Object.defineProperty({}, "passive", { get: function() { k = !0; return !1 } });
              window.addEventListener && (window.addEventListener("test", null, m), window.removeEventListener("test", null, m)) } catch (u) {
              k = !1
          }
          return k
      }(),
      ...
      ea = function(k, m, u) {
          ...
          for (var L = 0; F && L < F.length; L++)
              if (m = F[L], "." === m && 0 > N) N = L;
                  ...
                  if ("%" === m) D *= 100;
                  else if ("\u2030" === m) { D *= 1E3; continue } else if ("," === m[0] && "." === m[m.length - 1]) { D /= Math.pow(1E3, m.length - 1);
                      N = L + m.length - 1; continue } else "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || (J = !0);
          ...
          for (J = F = L = Q = N = 0; 0 < M.length;)
              if (m = M.pop(), "#" === m || "0" === m)
                  if (N++, N === H) { var W = D,
                          D = []; if ("0" === m)
                          for (m = H - Q - (W ? W.length : 0); 0 < m;) W.unshift("0"), m--; for (; 0 < W.length;) u = W.pop() + u, J++, 0 === J % F && (L === R && 0 < W.length) && (u = y + u) } else 0 < D.length ?
  ...
  V.prototype.setOptions = function(k, m) { if (qa[this._defaultsKey]) { var r = qa[this._defaultsKey],
              w; for (w in r) "publicProperties" !== w && r.hasOwnProperty(w) && (this[w] = k && w in k ? k[w] : m && w in m ? m[w] : r[w]) } else Ia && window.console && console.log("defaults not set") };
  ...
  V.prototype.createUserOptions = function(k) {
      if ("undefined" !== typeof k || this.options._isPlaceholder)
          if (this.parent.options._isPlaceholder &&
              ...
              m[r] = this.options } else this.options = "undefined" === typeof k ? {} : k, k = this.parent.options, this.optionsName ? m = this.optionsName : (m = this._defaultsKey) && 0 !== m.length ? (r = m.charAt(0).toLowerCase(), 1 < m.length && (r = r.concat(m.slice(1))),
              m = r) : m = void 0, k[m] = this.options
  };
  V.prototype.remove = function(k) { k = "undefined" === typeof k ? !0 : k; if (this.isOptionsInArray) { var m = this.parent.options[this.optionsName];
          Ca(m); var r = m.indexOf(this.options);
          0 <= r && m.splice(r, 1) } else delete this.parent.options[this.optionsName];
  ...
  V.prototype.removeEventListener = function(k, m) { if (k && m && this._eventListeners[k])
  ...
  ia.prototype.measureText = function() { this._lineHeight = Ya(this.fontFamily, this.fontSize, this.fontWeight); if (null === this.maxWidth) throw "Please set maxWidth and height for TextBlock";
  ...
  y = Qa.Chart = function() {
          ...
          (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) ? (this.container.innerHTML = "", d = a = 0, a = this.options.width ?
              ...
              (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Ba(this.ctx), this._preRenderCtx = this._preRenderCanvas.getContext("2d"), this._preRenderCtx.textBaseline = "top", Ba(this._preRenderCtx), w ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = ta(a, d), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas), this.plotArea.ctx = this.plotArea.canvas.getContext("2d")),
                  this.overlaidCanvas = ta(a, d), this.overlaidCanvas.style.position = "absolute", this.overlaidCanvas.style.webkitTapHighlightColor = "transparent", this.overlaidCanvas.style.WebkitUserSelect = "none", this.overlaidCanvas.style.MozUserSelect = "none", this.overlaidCanvas.style.msUserSelect = "none", this.overlaidCanvas.style.userSelect = "none", this.overlaidCanvas.getContext && (this._canvasJSContainer.appendChild(this.overlaidCanvas), this.overlaidCanvasCtx = this.overlaidCanvas.getContext("2d"), this.overlaidCanvasCtx.textBaseline =
                      ...
                      ua(b._dropdownMenu) }, this.allDOMEventHandlers), J(this.overlaidCanvas, "mouseout", function(a) { b._mouseEventHandler(a) }, this.allDOMEventHandlers), J(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerDown" :
                      "touchstart",
      ...
      m.prototype.destroy = function() {
          ...
          for (var d = 0; d < a.length; d++) { var c = a[d][0],
                  ...
                  f = a[d][3],
                  f = f || !1;
              c.removeEventListener ? c.removeEventListener(b, e, f) : c.detachEvent && c.detachEvent("on" + b, e) } this.allDOMEventHandlers = [];
      ...
      m.prototype._updateOptions = function() {
          ...
          if (this.options.zoomEnabled || this.panEnabled) {
              if (!this._zoomButton) {
                  ...
                  J(this._zoomButton, "click", function() { a.zoomEnabled ? (a.zoomEnabled = !1, a.panEnabled = !0, va(a, a._zoomButton, "zoom")) : (a.zoomEnabled = !0, a.panEnabled = !1, va(a, a._zoomButton, "pan"));
      ...
      m.prototype.setLayout = function() {
          ...
          if (0 < this._axes.length && this.options.zoomEnabled && (this.zoomEnabled || this.panEnabled))
              for (d = 0; d < this._axes.length; d++)
                  if (null !== this._axes[d].viewportMinimum || null !== this._axes[d].viewportMaximum) { c = !0; break } c ? (Ma(this._zoomButton, this._resetButton), this._toolBar.style.border = this.toolbar.borderThickness +
          ...
          for (d = 0; d < this._axes.length; d++)
              if (this._axes[d].scaleBreaks && this._axes[d].scaleBreaks._appliedBreaks.length) { w ? (this._breaksCanvas = ta(this.width, this.height, !0), this._breaksCanvasCtx = this._breaksCanvas.getContext("2d")) : (this._breaksCanvas = this.canvas, this._breaksCanvasCtx = this.ctx); break } this._preRenderCanvas = ta(this.width, this.height);
      ...
      m.prototype.renderElements = function() {
          ...
          var c = [];
          if (this.animatedRender) { var b = ta(this.width, this.height);
              b.getContext("2d").drawImage(this.canvas, 0, 0, this.width, this.height) } jb(this);
          ...
          }, function() { c = []; for (var a = 0; a < p.plotInfo.plotTypes.length; a++)
          ...
          this.renderCount++;
          Ia && (p = this, setTimeout(function() { var a = document.getElementById("ghostCanvasCopy");
              a && (Na(a, p.width, p.height), a.getContext("2d").drawImage(p._eventManager.ghostCanvas, 0, 0)) }, 2E3));
              ...
              if (a = this.data[d], a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= m._supportedChartTypes.indexOf(a.type)) {
                  for (var c = null, b = !1, e = null, f = !1, l = 0; l < this.plotInfo.plotTypes.length; l++)
                      if (this.plotInfo.plotTypes[l].type === a.type) { b = !0;
                          c = this.plotInfo.plotTypes[l]; break } b || (c = { type: a.type, totalDataSeries: 0, plotUnits: [] }, this.plotInfo.plotTypes.push(c));
                  for (l = 0; l <
          ...
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
              for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = !1, t = !1, A = [], h = 0; h < a.dataSeriesIndexes.length; h++) {
                  ...
                  for (n = 0; n < p.dataPoints.length; n++) {
                      ...
                      b > c.max && (c.max = b);
                      if (0 < n) {
                          if (a.axisX.logarithmic) { var s = b / p.dataPoints[n - 1].x;
                              1 > s && (s = 1 / s);
                              c.minDiff > s && 1 !== s && (c.minDiff = s) } else s = b - p.dataPoints[n -
          ...
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
              for (var d = a.axisY.dataInfo,
                  ...
                  for (p = 0; p < h.dataPoints.length; p++) {
                      ...
                      if ((e = h.dataPoints[p].y) && e.length) { f = Math.min.apply(null, e);
                          l = Math.max.apply(null, e);
                          v = !0; for (var x = 0; x < e.length; x++) null === e.k && (v = !1);
                          v && (n || (k = g), g = b) } b < c.min && (c.min = b);
                      b > c.max && (c.max = b);
                      f < d.min && (d.min = f);
                      l > d.max && (d.max = l);
                      ...
                      if (!(b < ka) || n) {
                          ...
                          if (c.viewPortMin === b && e)
                              for (x = 0; x < e.length; x++)
                                  if (null === e[x] && g < b) { c.viewPortMin = g; break } null === e ? c.viewPortMin === b && g < b &&
      ...
      m.prototype.calculateAutoBreaks = function() {
          ...
          function c(a) {
              if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <=
                  ...
                  for (var b = a.axisX.dataInfo, c = b.min, d = b.max, f = b._dataRanges, g, h = 0, l = 0; l < a.dataSeriesIndexes.length; l++) { var p = e.data[a.dataSeriesIndexes[l]]; if (!(4 > p.dataPoints.length))
          ...
          for (var b, e = this, f = !1, l = 0; l <
              ...
              if (this._axes[l].scaleBreaks && this._axes[l].scaleBreaks.autoCalculate && 1 <= this._axes[l].scaleBreaks.maxNumberOfAutoBreaks) { f = !0;
                  this._axes[l].dataInfo._dataRanges = []; for (var t = 0; t < 100 / Math.max(parseFloat(this._axes[l].scaleBreaks.collapsibleThreshold) || 10, 10); t++) this._axes[l].dataInfo._dataRanges.push({ min: Infinity, max: -Infinity }) } if (f) {
              ...
              for (l = 0; l < this._axes.length; l++)
                  if (this._axes[l].dataInfo._dataRanges) {
                      ...
                      if (this._axes[l].dataInfo.dataPointYPositiveSums) { var q = this._axes[l].dataInfo.dataPointYPositiveSums;
                          p = h; for (t in q)
                              if (q.hasOwnProperty(t) && !isNaN(t) && (n = q[t], !r(n))) { var g = Math.floor((n - A) / b);
                                  n < p[g].min && (p[g].min = n);
                                  n > p[g].max && (p[g].max = n) } delete this._axes[l].dataInfo.dataPointYPositiveSums }
                      ...
                      for (t = 0; t < h.length - 1; t++)
                          if (p = h[t].max, isFinite(p))
                              for (; t < h.length - 1;)
                                  if (A = h[t + 1].min, isFinite(A)) { n = A - p;
                                      n > b && f.push({ diff: n, start: p, end: A }); break } else t++;
      ...
      m.prototype.getDataPointAtXY =
          function(a, d, c) {
              ...
              for (var b = [], e = this._dataInRenderedOrder.length - 1; 0 <= e; e--) { var f = null;
                  (f = this._dataInRenderedOrder[e].getDataPointAtXY(a, d, c)) && b.push(f) } a = null;
              d = !1;
              for (c = 0; c < b.length; c++)
                  if ("line" === b[c].dataSeries.type || "stepLine" === b[c].dataSeries.type || "area" === b[c].dataSeries.type || "stepArea" === b[c].dataSeries.type)
                      if (e = la("markerSize", b[c].dataPoint, b[c].dataSeries) || 8, b[c].distance <= e / 2) { d = !0; break } for (c = 0; c < b.length; c++) d && "line" !== b[c].dataSeries.type && "stepLine" !== b[c].dataSeries.type &&
          ...
          if (a.changedTouches && this.interactivityEnabled) {
              ...
              if (!(c && 1 < c.length)) {
                  ...
                  try { var l = e.y - this._lastTouchData.y,
                          f = e.time - this._lastTouchData.time; if (1 < Math.abs(l) && this._lastTouchData.scroll || 5 < Math.abs(l) && 250 > f) this._lastTouchData.scroll = !0 } catch (t) {} this._lastTouchEventType =
                      a.type;
          ...
          if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
              ...
              if (this.panEnabled || this.zoomEnabled) {
                  if (this.panEnabled)
                      ...
                      2 < Math.abs(c - e) && 2 < Math.abs(b - f) && this._zoomPanToSelectedRegion(c, b, e, f) && (l = !0) } l && (this._ignoreNextEvent = !0, this._dispatchRangeEvent("rangeChanging", "zoom"), this.stockChart && (this.stockChart.navigator && this.stockChart.navigator.enabled) && (this.stockChart._rangeEventParameter ||
      ...
      m.prototype.preparePlotArea = function() {
          ...
          if ((this.axisX[0] || this.axisX2[0]) &&
              ...
              if (this.axisY && 0 < this.axisY.length && this.axisY[0]) { var c = this.axisY[0];
                  ...
                  a.width = a.x2 - a.x1;
                  a.height = a.y2 - a.y1 } this.axisY2 && 0 < this.axisY2.length && this.axisY2[0] && (c = this.axisY2[0], a.x1 = d.x1 < d.x2 ?
                      ...
                      for (var C = !1, s = 0; s < p.length; s++)
                          if (x = p[s].x.getTime ? p[s].x.getTime() : p[s].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !C)))
                              if ("number" !== typeof p[s].y) 0 < s && !(h.connectNullData || C || m) && (c.stroke(), w && b.stroke()), C = !0;
                                  ...
                                  if (0 < p[s].markerSize || 0 < h.markerSize) { var B = h.getMarkerProperties(s, x, r, c);
                                      f.push(B);
                                      z = Q(z);
                                      w && f.push({ x: x, y: r, ctx: b, type: B.type, size: B.size, color: z, borderColor: z, borderThickness: B.borderThickness }) }(p[s].indexLabel ||
                  ...
                  if (0 < s.length) {
                      ...
                      for (h = 0; h < s.length; h++)
                          if (b = s[h].x.getTime ? s[h].x.getTime() : s[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[h].y) {
                              ...
                              else if (n = a.axisY.convertValueToPixel(s[h].y), 0 <= s[h].y) { var B = "undefined" !== typeof f[b] ? f[b] : 0;
                                  n -= B;
                                  z = q - B;
                                  f[b] = B + (z - n) } else B = l[b] ? l[b] : 0, z = n + B, n = q + B, l[b] = B + (z - n);
                  ...
                  if (0 < s.length)
                      for (var x = 5 < g && m.bevelEnabled ? !0 : !1,
                          ...
                          if (b = s[h].x.getTime ? s[h].x.getTime() : s[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[h].y) {
                              ...
                              else if (n = a.axisY.convertValueToPixel(n), 0 <= s[h].y) { var B = "undefined" !== typeof f[b] ? f[b] : 0;
                                  n -= B;
                                  z = q - B;
                                  a.dataSeriesIndexes.length - 1 === v && 1 >= Math.abs(e.y1 - n) && (n = e.y1);
                                  f[b] = B + (z - n) } else B = "undefined" !== typeof l[b] ? l[b] : 0, z = n + B, n = q + B, a.dataSeriesIndexes.length - 1 === v && 1 >= Math.abs(e.y2 - z) && (z = e.y2), l[b] =
                                  B + (z - n);
                              b = s[h].color ? s[h].color : m._colorSet[h % m._colorSet.length];
                              ca(c, r, n, C, z, b, 0, null, x && 0 <= s[h].y, 0 > s[h].y && x, !1, !1, m.fillOpacity);
                              b = m.dataPointIds[h];
                      ...
                      for (h = 0; h < s.length; h++)
                          if (b = s[h].x.getTime ? s[h].x.getTime() : s[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" ===
                              ...
                              if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < s[h].y) t[b] = s[h].y + (t[b] ? t[b] : 0), 0 < t[b] && (z = f[b] ? f[b] : q, f[b] = p = a.axisY.convertValueToPixel(t[b]));
                                  ...
                                  0 <= s[h].y) { var B = f[b] ? f[b] : 0;
                                  z = q + B;
                                  p += B;
                                  f[b] = B + (p - z) } else B = l[b] ? l[b] : 0, z = p - B, p = q - B, l[b] = B + (p - z);
                              b = s[h].color ? s[h].color : m._colorSet[h % m._colorSet.length];
                      ...
                      for (h = 0; h < s.length; h++)
                          if (b = s[h].x.getTime ? s[h].x.getTime() : s[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[h].y) {
                              ...
                              var C =
                                  ...
                                  z = C + g << 0;
                              if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < s[h].y) { t[b] = r + (t[b] ? t[b] : 0); if (0 >= t[b]) continue;
                                  r = f[b] ? f[b] : q;
                                  f[b] = p = a.axisY.convertValueToPixel(t[b]) } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= s[h].y) A[b] = r + (A[b] ? A[b] : 0), p = l[b] ? l[b] : q, l[b] = r = a.axisY.convertValueToPixel(A[b]);
              ...
              if (!(0 >= a.dataSeriesIndexes.length)) {
                  ...
                  for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                      ...
                      if (0 < v.length) {
                          ...
                          f.lineWidth = g.lineThickness;
                          var S = "solid";
                          if (f.setLineDash) { var P = N(g.nullDataLineDashType, g.lineThickness),
                                  S = g.lineDashType,
      ...
      m.prototype.renderStackedArea = function(a) {
          function d() { if (!(1 > h.length)) { for (0 < B.lineThickness && b.stroke(); 0 < h.length;) { var a = h.pop();
                      b.lineTo(a.x, a.y);
                      w && r.lineTo(a.x, a.y) } b.closePath();
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (var e = [], C = 0; C < a.dataSeriesIndexes.length; C++) { var z = a.dataSeriesIndexes[C],
                      B = this.data[z],
                      u = B.dataPoints;
                  B.dataPointIndexes = []; for (q = 0; q < u.length; q++) z = u[q].x.getTime ? u[q].x.getTime() : u[q].x, B.dataPointIndexes[z] = q, e[z] || (p.push(z), e[z] = !0);
                  p.sort(Ra) }
              for (C = 0; C < a.dataSeriesIndexes.length; C++) {
                  ...
                  if (0 < p.length) {
                      ...
                      E = "solid";
                      if (b.setLineDash) { var P = N(B.nullDataLineDashType, B.lineThickness);
                          E = B.lineDashType; var D = N(E, B.lineThickness);
                          b.setLineDash(D) }
                      for (var aa = !0, q = 0; q < p.length; q++) {
                          ...
                          if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !aa)))
                              if ("number" !== typeof fa.y) B.connectNullData || (aa || x) || d(), aa = !0;
                                  ...
                                  var ma = A[f] ? A[f] : 0;
                                  if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) { n[f] = fa.y + (n[f] ? n[f] : 0); if (0 >= n[f] && a.axisY.logarithmic) continue;
                                      k = a.axisY.convertValueToPixel(n[f]) } else k = a.axisY.convertValueToPixel(fa.y), k -= ma;
                                  h.push({
                                      x: g,
                                      y: m - ma
                                  });
                                  ...
                                  if (0 <= B.dataPointIndexes[f]) { var F = B.dataPointIds[B.dataPointIndexes[f]];
                                      this._eventManager.objectMap[F] = { id: F, objectType: "dataPoint", dataSeriesIndex: z, dataPointIndex: B.dataPointIndexes[f], x1: g, y1: k } } 0 <= B.dataPointIndexes[f] &&
      ...
      m.prototype.renderStackedArea100 = function(a) {
          function d() { for (0 < B.lineThickness && b.stroke(); 0 < h.length;) { var a = h.pop();
                  b.lineTo(a.x, a.y);
                  w && E.lineTo(a.x, a.y) } b.closePath();
              b.globalAlpha = B.fillOpacity;
              b.fill();
              b.globalAlpha = 1;
              b.beginPath();
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (u = 0; u < a.dataSeriesIndexes.length; u++) {
                  ...
                  if (0 < p.length) {
                      ...
                      s = "solid";
                      if (b.setLineDash) { var P = N(B.nullDataLineDashType, B.lineThickness);
                          s = B.lineDashType; var F = N(s, B.lineThickness);
                          b.setLineDash(F) }
                      for (var aa = !0, q = 0; q < p.length; q++) {
                          var f = p[q],
                              fa = null,
      ...
      m.prototype.renderRangeArea = function(a) {
          function d() {
              if (x) {
                  ...
                  b.globalAlpha = 1;
                  e.fill();
                  if (0 < p.lineThickness) { b.beginPath();
                      b.moveTo(a.x, a.y2); for (c = 0; c < k.length; c++) a = k[c], b.lineTo(a.x, a.y2);
                      b.moveTo(k[0].x, k[0].y1); for (c = 0; c < k.length; c++) a = k[c], b.lineTo(a.x, a.y1);
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
                  ...
                  if (0 < n.length) {
                      ...
                      b.lineWidth = p.lineThickness;
                      var B = "solid";
                      if (b.setLineDash) { var y = N(p.nullDataLineDashType, p.lineThickness),
                              B = p.lineDashType,
                              D = N(B, p.lineThickness);
                          b.setLineDash(D) }
              ...
              if (0 < d.length) {
                  ...
                  if (0 < h.lineThickness) {
                      ...
                      for (g = f = 0; f < d.length - 3; f += 3, g++) { if (r[g].newStrokeStyle || r[g].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(d[f].x, d[f].y), r[g].newStrokeStyle && (b.strokeStyle = r[g].newStrokeStyle), r[g].newLineDashArray && b.setLineDash(r[g].newLineDashArray);
                          b.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y) } b.stroke()
                  }
                  b.beginPath()
              }
          }
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (var k = 0; k < a.dataSeriesIndexes.length; k++) {
                  ...
                  if (0 < p.length) {
                      ...
                      var C = "solid",
                          z;
                      if (b.setLineDash) { var B = N(h.nullDataLineDashType, h.lineThickness),
                              C = h.lineDashType;
                      ...
                      for (g = !1; n < p.length; n++)
                          if (q = p[n].x.getTime ? p[n].x.getTime() : p[n].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !g)))
                              if (null !== p[n].y && p[n].y.length && "number" === typeof p[n].y[0] && "number" === typeof p[n].y[1]) {
                                  ...
                                  if (0 !== p[n].markerSize &&
                                      (0 < p[n].markerSize || 0 < h.markerSize)) { var D = h.getMarkerProperties(n, q, g, b);
                                      f.push(D); var S = Q(y);
              ...
              for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                  ...
                  if (0 < u.length)
                      for (var E = 5 < q && r.bevelEnabled ? !0 : !1, C = !1, z = null, B = null, l = 0; l < u.length; l++)
                          if (u[l].getTime ? p = u[l].x.getTime() : p = u[l].x, "number" !== typeof u[l].y) { if (0 < l && !C && r.connectNullData) var y = r.options.nullDataLineDashType || !u[l - 1].lineDashType ? r.nullDataLineDashType : u[l - 1].lineDashType;
                              C = !0 } else {
      ...
      var Y = function(a, d, c, b, e, f, l, k, m) {
          if (!(0 > c)) {
              ...
              if (!w) { var h = Number((l % (2 * Math.PI)).toFixed(8));
                  Number((f % (2 * Math.PI)).toFixed(8)) === h && (l -= 1E-4) } a.save();
              a.globalAlpha = k;
          ...
          function d() {
              if (h && p) {
                  for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < p.length; e++) {
                      ...
                      k.midAngle = f;
                      if (k.midAngle > Math.PI / 2 - s && k.midAngle < Math.PI / 2 + s) { if (0 === a || g[c].midAngle > k.midAngle) c = e;
                          a++ } else if (k.midAngle > 3 * Math.PI / 2 - s && k.midAngle < 3 * Math.PI / 2 + s) { if (0 === b || g[d].midAngle > k.midAngle) d = e;
                          b++ } k.hemisphere = f > Math.PI / 2 && f <= 3 * Math.PI / 2 ? "left" : "right";
          ...
          function l() {
              ...
              for (var c = a = 0, d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                  ...
                  if ("inside" !== h.indexLabelPlacement) {
                      w = B * u;
                      for (a = 0; a < p.length; a++) { var k = g[a];
                  ...
                  var K = function(a, b, c) { for (var d = [], e = 0; d.push(g[b]), b !== c; b = (b + 1 + p.length) % p.length);
                      ...
                      for (var a = -1, c = -1, d = 0, f = !1, h = 0; h < p.length; h++)
                          if (f = !1, t = g[h], t.indexLabelText) {
                              ...
                              if (null !== l) {
                                  ...
                                  z = b(t, k);
                                  var q;
                                  if (q = 0 > z) { q = t.indexLabelTextBlock.x; var m = t.indexLabelTextBlock.y - t.indexLabelTextBlock.height / 2,
                                      ...
                                      q = t.indexLabelTextBlock.x + t.indexLabelTextBlock.width < k.indexLabelTextBlock.x - n || q > v + n || m > A + n || s < r - n ? !1 : !0 } q ? (0 > a && (a = h), l !== a && (c = l, d += -z), 0 === h % Math.max(p.length /
                                      10, 3) && (f = !0)) : f = !0;
          ...
          function k() {
              ...
              if (m.subtitles)
                  for (var a = 0; a < m.subtitles.length; a++) { var b = m.subtitles[a];
                      (b.dockInsidePlotArea || "center" === b.horizontalAlign && "center" === b.verticalAlign) && b.render() } m.legend && (m.legend.dockInsidePlotArea || "center" === m.legend.horizontalAlign && "center" ===
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              if (0 !== y) {
                  ...
                  this.pieDoughnutClickHandler = function(a) {
                      m.isAnimating ||
                          !r(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint, a.exploded = a.exploded ? !1 : !0, 1 < this.dataPoints.length && m._animator.animate(0, 500, function(a) { c(a);
                              k();
                  ...
                  this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function(a) {
                      ...
                      for (var b = g[0].startAngle + 2 * Math.PI * a, c = 0; c < p.length; c++) { var d = 0 === c ? g[c].startAngle : e,
                              e = d + (g[c].endAngle - g[c].startAngle),
                              f = !1;
                          e > b && (e = b, f = !0); var l = p[c].color ? p[c].color : h._colorSet[c % h._colorSet.length];
                          e > d && Y(m.plotArea.ctx, g[c].center, g[c].radius, l, h.type, d, e, h.fillOpacity, g[c].percentInnerRadius); if (f) break } k();
                      m.dispatchEvent("dataAnimationIterationEnd", { chart: m });
      ...
      m.prototype.renderFunnel = function(a) {
          ...
          function e() {
              ...
              e = !1;
              c = 0;
              for (var g, h = J - Z - V / 2, h = s.options.indexLabelMaxWidth ? s.indexLabelMaxWidth > h ? h : s.indexLabelMaxWidth : h, l = I.length - 1; 0 <= l; l--) { g = x[I[l].id];
                  c = I[l];
                  d = c.textBlock;
          ...
          function l() {
              function a(b,
                  c) { var d; if (0 > b || b >= I.length) return 0; var e, f = I[b].textBlock; if (0 > c) { c *= -1;
                      e = n(b);
                      d = k(e, b); if (d >= c) return f.y -= c, c; if (0 == b) return 0 < d && (f.y -= d), d;
                      d += a(e, -(c - d));
                      0 < d && (f.y -= d); return d } e = q(b);
                  d = k(b, e); if (d >= c) return f.y += c, c; if (b == O.length - 1) return 0 < d && (f.y += d), d;
                  d += a(e, c - d);
                  0 < d && (f.y += d); return d }
                  ...
                  for (l = O.length - 1; 0 < l; l--)
                      if (!I[l].isDirty) {
                          ...
                          if (I[l].textBlock.y < I[e].textBlock.y + I[e].height) {
                              d = d || l;
                              f = l;
                              for (h = 0; I[f].textBlock.y < I[e].textBlock.y + I[e].height + da;) { a = a || I[f].textBlock.y + I[f].height;
                                  h += I[f].height;
                                  h += da;
                                  f = e; if (0 >= f) { f = 0;
                                      h += I[f].height; break } e = n(f); if (0 > e) { f = 0;
                                      h += I[f].height; break } }
                              if (f != l) {
                                  g = I[f].textBlock.y;
                                  a -= g;
          ...
          function g(a) { for (var b, c = 0; c < x.length; c++)
                  if (O[c].y1 < a && O[c].y4 > a) { b = O[c]; break } return b ? (a = b.y6 ? a > b.y6 ? b.x3 + (b.x4 - b.x3) / (b.y4 - b.y3) * (a - b.y3) : b.x2 + (b.x3 - b.x2) / (b.y3 - b.y2) * (a - b.y2) : b.x2 + (b.x3 - b.x2) / (b.y3 - b.y2) * (a - b.y2), { x1: a, x2: a }) : -1 }
          ...
          function u(a) {
              ...
              if (y.subtitles)
                  for (var b = 0; b < y.subtitles.length; b++) { var c = y.subtitles[b]; if (c.dockInsidePlotArea || "center" === c.horizontalAlign && "center" === c.verticalAlign) y.subtitles.ctx = a, c.render() } y.legend && (y.legend.dockInsidePlotArea ||
                  ...
                  if (-1 !== P) {
                      ...
                      this.funnelPyramidClickHandler = function(a) {
                          ...
                          if (!ha && !y.isAnimating && (r(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) &&
                              (b = s.reversed ? x.length - 1 - a.dataPointIndex : a.dataPointIndex, 0 <= b)) { a = b; if ("funnel" === s.type || "pyramid" === s.type) s.reversed ? x[x.length - 1 - a].exploded = x[x.length - 1 - a].exploded ? !1 : !0 : x[a].exploded = x[a].exploded ? !1 : !0;
                              m(y, b, 500) }
                      };
                      return { source: R, dest: this.plotArea.ctx, animationCallback: function(a, b) { L.fadeInAnimation(a, b);
                              1 <= a && (m(y, -1, 500), u(y.plotArea.ctx || y.ctx)) }, easingFunction: L.easing.easeInQuad, animationBase: 0 }
                  }
              }
          }
      };
      ...
      m.prototype.replaceKeywordsWithValue = function(a, d, c, b, e) {
          ...
          if ((0 <= c.type.indexOf("stacked") || "pie" === c.type || "doughnut" === c.type || "funnel" === c.type || "pyramid" === c.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
              ...
              do { m = ""; if (c.percentFormatString) m = c.percentFormatString;
                  else { var m = "#,##0.",
                          h = Math.max(Math.ceil(Math.log(1 / Math.abs(l)) / Math.LN10), 2); if (isNaN(h) || !isFinite(h)) h = 2; for (var p = 0; p < h; p++) m += "#";
                      c.percentFormatString = m } a = a.replace("#percent", ea(l, m, f._cultureInfo));
                  a = a.replace("#total", ea(k, c.yValueFormatString ? c.yValueFormatString : "#,##0.########", f._cultureInfo)) } while (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))
          }
          return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
              ...
              try { var g = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);
                  g && 0 < g.length && (h = Ga(g[2]), a = Ga(g[1])) } catch (l) {} g = null;
          ...
          for (var k = 0, m = 0; m < l.length; m++) {
              for (var h = l[m], p = 0, n = 0; n < h.items.length; n++) {
                  ...
                  if ("error" === q.chartType) { this.ctx.strokeStyle = this.errorMarkerColor[0];
                      ...
                      this.ctx.stroke();
                      this.errorMarkerColor.shift() } W.drawMarker(g +
      ...
      H.prototype.getDataPointAtX = function(a, d) {
          ...
          for (;;) {
              ...
              if (0 <= f && f < this.dataPoints.length) { var b = this.dataPoints[f],
                  ...
                  b = n;
                  b <= k ? k = b : 0 < l ? m++ : h++; if (1E3 < m && 1E3 < h) break } else if (0 > p - e && p + e >= this.dataPoints.length) break; - 1 === l ? (e++, l = 1) : l = -1
          }
      ...
      D.prototype.createLabels = function() {
          ...
          if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
              ...
              if (this.labels) { a = Math.ceil(b); for (var b = Math.ceil(this.intervalStartPosition), g = !1, c = b; c < this.viewportMaximum; c += a)
                      ...
                      else { g = !1; break } g && (this.interval = a, this.intervalStartPosition = b) }
          ...
          for (b = 0; b < this._labels.length; b++) { a = this._labels[b].textBlock;
              a.maxWidth = f;
              a.maxHeight = l; var v = a.measureText();
              m = v.height } e = [];
          q = n = 0;
      ...
      D.prototype.renderLabelsTicksAndTitle = function() {
              ...
              if ("bottom" === this._position || "top" === this._position)
                  if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                      for (var c = [], e = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, l, k = this.viewportMaximum, m = this.lineCoordinates.width / Math.log(this.range), h = this._labels.length -
                              1; 0 <= h; h--) { n = this._labels[h]; if (n.position < this.viewportMinimum) break;
                          n.position > this.viewportMaximum || !(h === this._labels.length - 1 || l < Math.log(k / n.position) * m / e) || (c.push(n), k = n.position, l = n.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle))) } this._labels = c
                  } else {
                  ...
                  if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                      ...
                      this._labels = c
                  } else { for (h = 0; h < this._labels.length; h++) n = this._labels[h], n.position < this.viewportMinimum || (p = n.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), b += p);
          ...
          if ("bottom" === this._position) {
              ...
              "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationEnd",
                  function() { for (h = 0; h < a._labels.length; h++)
                          if (n = a._labels[h], !(n.position < a.viewportMinimum || n.position > a.viewportMaximum) && (q = a.getPixelCoordinatesOnAxis(n.position), a.tickThickness)) { a.ctx.lineWidth = a.tickThickness;
      ...
      D.prototype.renderStripLinesOfThicknessType = function(a) {
          if (this.stripLines &&
              ...
              for (var d = this, c, b = 0, e = 0, f = !1, l = !1, k = [], m = [], l = !1, b = 0; b < this.stripLines.length; b++) { var h = this.stripLines[b];
              ...
              for (b = 0; b < this._stripLineLabels.length; b++)
                  ...
                  for (b = 0; b < k.length; b++) h =
                      k[b], h.showOnTop ? f || (f = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() { this.ctx.save();
                          this.ctx.beginPath();
                          this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height);
                          this.ctx.clip(); for (e = 0; e < k.length; e++) h = k[e], h.showOnTop && h.render();
      ...
      D.prototype.setViewPortRange = function(a, d) { this.sessionVariables.newViewportMinimum = this.viewportMinimum = Math.min(a, d);
      ...
      oa(Z, V);
      oa(U, V);
      U.prototype.createUserOptions = function(a) { if ("undefined" !== typeof a || this.options._isPlaceholder) { var d = 0;
          ...
          if (0 !== this.spacing ||
              ...
              if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                  ...
                  for (q = 0; q < p; q++) this.ctx.bezierCurveTo(m + f * a, h - a, m + f * a, h - 2 * a, m, h - 3 * a), h -= 3 * a, f *= -1
                      ...
                      h = e + a;
                      m = b + a;
                      p = (k - h) / a / 2; for (q = 0; q < p; q++) this.ctx.lineTo(m, h), m += 2 * f * a, h += 2 * a, f *= -1;
                      this.ctx.lineTo(m, h);
                      m += l - b; for (q = 0; q < p + 1; q++) this.ctx.lineTo(m, h), m += 2 * f * a, h -= 2 * a, f *= -1;
                      this.ctx.lineTo(m + f * a, h + a) } } else if ("left" === this.scaleBreaks.parent._position || "right" === this.scaleBreaks.parent._position)
                  ...
                  h = e - a;
                  m = b + a;
                  p = (l - m) / a / 2; for (q = 0; q < p; q++) this.ctx.lineTo(m, h), h += 2 * f * a, m += 2 * a, f *= -1;
                  this.ctx.lineTo(m, h);
                  h += k - e; for (q = 0; q < p + 1; q++) this.ctx.lineTo(m, h), h += 2 * f * a, m -= 2 * a, f *= -1;
                  this.ctx.lineTo(m + a, h + f * a) } 0 < n && this.ctx.stroke();
              this.ctx.closePath();
      ...
      $.prototype.hide = function() { this.chart.resetOverlayedCanvas();
                  ...
                  if ("bottom" === this.parent._position || "top" === this.parent._position) {
                      ...
                      if (this.parent.labels)
                          for (p = Math.ceil(this.parent.interval), v = 0; v < this.parent.viewportMaximum; v +=
                              ...
                              else { C = !1; break } if (C) { if ("axisX" === this.parent.type)
          ...
          if (!this.chart.disableToolTip) {
              ...
              if (this.shared && this.enabled &&
                  ...
                  if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                      var m = [];
                      if (this.chart.axisX)
                          for (var u = 0; u < this.chart.axisX.length; u++) { for (var k = this.chart.axisX[u].convertPixelToValue({ y: d }), h = null, b = 0; b < this.chart.axisX[u].dataSeries.length; b++)(h = this.chart.axisX[u].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX[u].dataSeries[b], null !== h.dataPoint.y && m.push(h));
                              h = null }
      ...
      X.prototype.getToolTipInnerHTML = function(a) {
          ...
          for (var d = null, c = null, b = null, e = 0, f = "", k = !0, m = 0; m < a.length; m++)
              if (a[m].dataSeries.toolTipContent || a[m].dataPoint.toolTipContent) { k = !1; break } if (k && (this.content && "function" === typeof this.content || this.contentFormatter)) a = { chart: this.chart, toolTip: this.options, entries: a }, d = this.contentFormatter ? this.contentFormatter(a) : this.content(a);
      ...
      X.prototype.showAtX = function(a, d) {
          ...
          if (0 < f.length) {
              for (k = 0; k < f.length; k++)
                  ...
                  else { e = !1; break } if (e) return this.hide(), !1;
              this.highlightObjects(f);
              this._entries = f;
              b = "";
          ...
          if ("mousemove" === a.type || "click" === a.type) {
              ...
              for (c = 0; c < this.mouseoveredObjectMaps.length; c++) {
                  ...
                  for (b = 0; b < d.length; b++)
                      if (d[b].id === this.mouseoveredObjectMaps[c].id) { f = !1; break } f ? this.fireEvent(this.mouseoveredObjectMaps[c], "mouseout", a) : e.push(this.mouseoveredObjectMaps[c])
              }
              this.mouseoveredObjectMaps = e;
              for (c = 0; c < d.length; c++) {
                  e = !1;
                  for (b = 0; b < this.mouseoveredObjectMaps.length; b++)
                      if (d[c].id === this.mouseoveredObjectMaps[b].id) { e = !0; break } e || (this.fireEvent(d[c], "mouseover", a), this.mouseoveredObjectMaps.push(d[c]));
